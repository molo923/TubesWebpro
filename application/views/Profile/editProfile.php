...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <link href="<?php echo base_url('assets/profil/css/style.css')?>" rel="stylesheet">
  </head>
<body>
  ...
  <div class="container">
      <div class="row profile">
  		<div class="col-md-3">
              ...
              <img style="width : 35px; height : 35px;"src="https://cdn1.iconfinder.com/data/icons/mini-solid-icons-vol-11/16/505-512.png">
               <b style="font-size : 12px;">
                 berat sampah :<?php echo $key['berat sampah'] ?> kg
               </b>
               <br>
               <br>
               <img style="width : 35px; height : 35px;"src="https://cdn0.iconfinder.com/data/icons/shopping-and-ecommerce-1/38/Shopping_icons_1_Converted-09-512.png">
                <b style="font-size : 12px;">
  				...
  				<div class="profile-usermenu">
  					<ul class="nav">
  						<li>
  							<a href="<?= base_url('Profile/'); ?>editPage">
